...
<div class="container">
  ...
  $queryD="SELECT * FROM horario_ubc_turismo_park where COD_PARK='201'";
...
<div class="container">
  ...
  <div class="col-md-4">
  <button class="btn btn-primary" onclick="window.location.href='http://localhost:82/Prototipo/Centros_Turisticos_Consulta_Precios.php'">Consultar</button>
  </div>
  </section>
</div>
<footer>
