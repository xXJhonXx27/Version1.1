...
<div class="container">
  ...
  $queryD="SELECT * FROM horario_ubc_turismo_park where COD_PARK='202'";
  $resultadoC=mysqli_query($conexion,$queryD);
  $contadorR=1;
  while ($registroT=mysqli_fetch_array ($resultadoC)){
    echo "<div class='container'><section class='main row'><div class='cold-md-1'>Codigo Del Parque: ";
    echo $registroT [0]."</div><div class='cold-md-1'> Nombre Del parque: ";
    echo $registroT [1]."</div><div class='cold-md-1'> Tipo De Turismo Del parque: ";
    echo $registroT [2]."</div><div class='cold-md-1'> Ubicacion Geografica Del parque: ";
    echo $registroT [3]."</div><div class='cold-md-1'> Horarios Manejados En El parque: ";
    echo $registroT [4]."</div><div class='cold-md-1'></div></div></section>";
  $contadorR++;
  }
?>
<div class="container">
  ...
  <div class="col-md-8">
  <h3>¿Te Interesa Este Parque O parque?, Puedes Consultar El Precio De Este Lugar A Nuestra Derecha</h3>
  </div>
  <div class="col-md-4">
  <button class="btn btn-primary" onclick="window.location.href='http://localhost:82/Prototipo/Centros_Turisticos_Consulta_Precios_Salitre.php'">Consultar</button>
  </div>
  </section>
</div>
<footer>
