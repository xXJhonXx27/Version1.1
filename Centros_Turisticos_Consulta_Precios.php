...
<div class="container">
  ...
  $queryD="SELECT * FROM valor_turismo_park where TPO_TURISM_PARK='Ecologico'";
  $resultadoC=mysqli_query($conexion,$queryD);
  $contadorR=1;
  while ($registroT=mysqli_fetch_array ($resultadoC)){
     echo "<div class='container'><section class='main row'><div class='cold-md-1'>Tipo De Turismo: ";
    echo $registroT [0]."</div><div class='cold-md-1'> Tipo De Eventos En El Parque: ";
    echo $registroT [1]."</div><div class='cold-md-1'> Precio Del Parque: ";
    echo $registroT [2]."</div><div class='cold-md-1'></div></div></section>";
  $contadorR++;
  }
?>
<div class="container">
  ...
  <div class="col-md-8">
  <h3>No Olvides Dejarnos Tu Opinion</h3>
  </div>
  <div class="col-md-4">
  <input type="text">
